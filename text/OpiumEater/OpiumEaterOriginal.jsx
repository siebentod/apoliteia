function OpiumEaterOriginal() {
    return (
      ...
      <br/>
      <span className="spanIndented">“—Humbly to express<br/>
      A penitential loneliness.”</span></p>
      <p>
      ...
      And those who always ate, now eat the more.</span>
      </p>
      <p>
      ...
      day-dreams or night-dreams) is suitable to one who in that character Humani nihil a se alienum putat.
      </p>
      ...
      strength of any one man; however, the groom was a man<br/>
      
      <span className="spanIndented">Of Atlantean shoulders, fit to bear<br/>
      The weight of mightiest monarchies;</span>
      </p>
      ...
      designed, drove me out to wander again.</p>
      <p>I know not whether my reader may have
      ...
      surface of their manners.</p>
      <p>This spirit of manners naturally communicates itself
      ...
      where he had slept. Or, if he <i>had</i> asked a party—as I once
      ...
      significantly suggested—was <i>I</i> that person? This doubt had never
      ...
      their Christian names—<i>Mary</i>, <i>Jane</i>, <i>Frances</i>, &amp;c.
      ...
      outcast—
      <span className="spanIndented">
      Lord of my learning, and no land beside—</span>
      ...
      <span className="spanIndented">To slacken virtue, and abate her edge,<br/>
      Than tempt her to do ought may merit praise.<br/>
      <i>Paradise Regained</i></span>.
      </p>
      <p>
      ...
      my early ejaculation—“And <i>that</i> way I would fly for comfort!”
      </p>
      ...
      1812—living in a cottage and with a single female servant (<i>honi soit
      ...
      should all cry out—Hear him! Hear him! As to the happiest <i>day</i>,
      ...
      <span className="spanIndented">That moveth altogether, if it move at all.</span>
      </p>
      <p>
      ...
      Whence sweeter grows our rest secure in massy hall.<br/>
      <i>Castle of Indolence</i>.</span>
      </p>
      <p>
      ...
      tea-pot—eternal <i>à parte ante</i> and <i>à parte post</i>—for I
      ...
      work of Spinosa’s—viz., <i>De Emendatione Humani Intellectus</i>. This
      ...
      people, the two words so often occurring in Livy—<i>Consul Romanus</i>,
      ...
      <p>
      As a final specimen, I cite one of a different character, from 1820.<br/>
      ...
      And again and yet again reverberated—everlasting farewells!<br/>And I awoke in struggles, and cried aloud—“I will sleep no more.”
      </p>
      <p>
      ...
      of Milton)<br/>
      <span className="spanIndented">With dreadful faces throng’d, and fiery arms.</span>
      </p>
      <h3>APPENDIX</h3>
      <p>
      ...
      others.</p>
      <p style={{ borderBottom: 'none', paddingBottom: 6 }}>Such an animal as the self-observing valetudinarian I know there is; I
      ...
      love of science and all its interests which induces me to make such an offer.<br/>
      Sept 30, 1822
      </p>
      <p className="annoContent"><b>FOOTNOTES</b><br/>
            <a id="footnote1"></a><a href="#citation1">1</a> “Not yet <i>recorded</i>,”
            I say; for there is one celebrated man of the present day, who, if all be true
            which is reported of him, has greatly exceeded me in quantity.<span className="bigBlank"/>
            <a id="footnote2"></a><a href="#citation2">2</a> A third exception might
            ...
            his manhood (which is his fault).<span className="bigBlank"/>
            <a id="footnote3"></a><a href="#citation3">3</a> I disclaim any allusion to
            <i>existing</i> professors, of whom indeed I know only one.<span className="bigBlank"/>
            <a id="footnote4"></a><a href="#citation4">4</a> To this same Jew, by the
            ...
            or other I believe I shall present it to the British Museum.<span className="bigBlank"/>
            <a id="footnote5"></a><a href="#citation5">5</a> The Bristol mail is the
            ...
            merchants.<span className="bigBlank"/>
            <a id="footnote6"></a><a href="#citation6">6</a> It will be objected that
            ...
            them deadened its effect and its attractions.<span className="bigBlank"/>
            <a id="footnote7"></a><a href="#citation7">7</a>
            Φιλον υπνη
            θελyητρον
            επικουρον
            νοσον.<span className="bigBlank"/>
            <a id="footnote8"></a><a href="#citation8">8</a> ηδυ
            δουλευμα. EURIP. Orest.<span className="bigBlank"/>
            <a id="footnote9"></a><a href="#citation9">9</a>
            αναξανδρων
            ’Αyαμεμνων.<span className="bigBlank"/>
            <a id="footnote10"></a><a href="#citation10">10</a>
            ομμα θεισ’
            ...
            regard from nominal friends.<span className="bigBlank"/>
            <a id="footnote11"></a><a href="#citation11">11</a> <i>Evanesced</i>: this
            ...
            because, says he,
            <span className="spanIndented">“Kings should disdain to die, and only <i>disappear</i>.”</span>
            They should <i>abscond</i>, that is, into the other world.<span className="bigBlank"/>
            <a id="footnote12"></a><a href="#citation12">12</a> Of this, however, the
            ...
            opium.<span className="bigBlank"/>
            <a id="footnote13"></a><a href="#citation13">13</a> Amongst the great herd
            ...
            on Anastasius, it reads excellently.<span className="bigBlank"/>
            <a id="footnote14"></a><a href="#citation14">14</a> I have not the book at
            ...
            of devotion,” &amp;c.<span className="bigBlank"/>
            <a id="footnote15"></a><a href="#citation15">15</a> A handsome newsroom, of
            ...
            mistake.<span className="bigBlank"/>
            <a id="footnote16"></a><a href="#citation16">16</a> I here reckon
            ...
            The reader sees how much I kept within Dr. Buchan’s indulgent allowance.<span className="bigBlank"/>
            <a id="footnote17"></a><a href="#citation17">17</a> This, however, is not a
            ...
            gratis.<span className="bigBlank"/>
            <a id="footnote18"></a><a href="#citation18">18</a> See the common accounts
            in any Eastern traveller or voyager of the frantic excesses committed by Malays
            who have taken opium, or are reduced to desperation by ill-luck at gambling.<span className="bigBlank"/>
            <a id="footnote19"></a><a href="#citation19">19</a> The reader must
            ...
            encouragement.<span className="bigBlank"/>
            <a id="footnote20"></a><a href="#citation20">20</a> William Lithgow. His
            book (Travels, &amp;c.) is ill and pedantically written; but the account of his
            own sufferings on the rack at Malaga is overpoweringly affecting.<span className="bigBlank"/>
            <a id="footnote21"></a><a href="#citation21">21</a> In saying this I mean
            ...
            what is worse, in a retrograde state.<span className="bigBlank"/>
            <a id="footnote22"></a><a href="#citation22">22</a> On which last notice I
            ...
            sort of information before him, I subjoin my diary:— [-- Table --]<br/>
            ...
            day, and could then have borne anything.</p></>
    )
  }
  
  export default OpiumEaterOriginal